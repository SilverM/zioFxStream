...
knn_results2 = Knnpredictor_2020_before.run()
# knn_results.run()
a = []
...
tab2 = Panel(child=row(s3,data_table), title="ETHUSD_day - SMA Crossover")
tab5 = Panel(child=row(s3_v2,data_table4), title="CADUSD_day - SMA Crossover")

tab3 = Panel(child = row(knn_results.plot(), data_table2), title = 'EURUSD_day - KNN')
